...
VALUES (1, 'patient@email.com', 'patient_password', 'patient_first_name', 'patient_last_name', NULL),
       (2, 'doctor@email.com', 'doctor_password', 'doctor_first_name', 'doctor_last_name', NULL);
...
VALUES (1, 1, 2, CURRENT_DATE, 1, 0, 'Me duele la cabeza', NULL),
       (2, 1, 2, CURRENT_DATE, 2, 1, 'Hola', NULL);
