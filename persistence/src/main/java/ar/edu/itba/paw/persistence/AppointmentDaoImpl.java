...
public class AppointmentDaoImpl implements AppointmentDao {
  ...
  private final static RowMapper<Appointment> APPOINTMENT_MAPPER = (rs, rowNum) -> {
    ...
    return new Appointment(appointmentId, patientId, doctorId, date, timeBlock, status, description);
  };
  ...
  public void updateAppointmentStatus(long appointmentId, AppointmentStatus status) {
    String update = new UpdateBuilder()
        .update("appointment")
