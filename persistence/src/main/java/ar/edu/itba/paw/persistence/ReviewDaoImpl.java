...
public class ReviewDaoImpl implements ReviewDao {
    ...
    public List<Review> getReviewsForDoctor(long doctorId) {
      ...
      String query = reviewQuery().where("doctor_id = '" + doctorId + "'").build();
      
      return jdbcTemplate.query(query, RowMappers.REVIEW_MAPPER);
    }
    ...
    private QueryBuilder reviewQuery() {
        return new QueryBuilder()
            ...
            .innerJoin("health_insurance_for_patient", "patient.patient_id = health_insurance_for_patient.patient_id");
    }
}
