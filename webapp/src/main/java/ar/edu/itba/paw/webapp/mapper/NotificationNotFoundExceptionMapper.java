...
public class NotificationNotFoundExceptionMapper
  ...
  private static final String MESSAGE_ID = "error.notificationNotFound";
  private static final Response.Status Status = Response.Status.NOT_FOUND;

  @Autowired private MessageSource messageSource;

  @Override
  public Response toResponse(NotificationNotFoundException e) {

    LOGGER.debug("Notification not found", e);
